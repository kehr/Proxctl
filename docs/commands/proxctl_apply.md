...
Apply high-risk planned changes
...
* [proxctl apply rotate](proxctl_apply_rotate.md)	 - Rotate Xray credentials
* [proxctl apply switch](proxctl_apply_switch.md)	 - Switch Xray Reality target
